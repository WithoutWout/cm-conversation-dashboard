...
- Pagination links use `onclick="goAllPage(n)"` and similar inline handlers intentionally.
...
- All HTML is built via string concatenation; always use `esc()` for any dynamic value.
